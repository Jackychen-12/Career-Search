          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className={`px-3 h-8 inline-flex items-center rounded-full text-[13px] transition ${
                view === "list" ? "bg-gray-800 text-white shadow-sm" : "text-gray-500 hover:text-gray-800"
              }`}
            >
              列表
            </button>
            <button
              ...
              className={`px-3 h-8 inline-flex items-center rounded-full text-[13px] transition ${
                view === "calendar" ? "bg-gray-800 text-white shadow-sm" : "text-gray-500 hover:text-gray-800"
              }`}
            >
              日历
            </button>
