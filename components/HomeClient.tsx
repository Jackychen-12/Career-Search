      ...
      <footer className="border-t border-gray-200/50 mt-12 bg-white/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 text-xs text-gray-400 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://github.com/Jackychen-12" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-brand-600 transition font-medium">
              Made by Jacky
            </a>
            <a href="https://github.com/Jackychen-12/Career-Search" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-brand-600 transition flex items-center gap-1">
